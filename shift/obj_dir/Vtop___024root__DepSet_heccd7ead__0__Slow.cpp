...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    // Body
    vlSelf->__Vcellout__top__h = VL_RAND_RESET_I(8);
    vlSelf->__Vcellout__top__out = VL_RAND_RESET_I(8);
    vlSelf->__Vcellinp__top__clk = VL_RAND_RESET_I(1);
    vlSelf->__Vcellinp__top__in = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__a = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__i = VL_RAND_RESET_I(1);
